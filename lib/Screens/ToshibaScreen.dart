...
class ToshibaScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final taskName = arguments['taskName'];
    final taskDescription = arguments['taskDescription'];
    return Scaffold(
        ...
        child: ListView(
          ...
          children: [
            ...
            newArrivalCard('Dell Pro', 'Reviews (4.9)', '\$ 15.59',
                'assets/NoPath - Copy (21)@3x.png'),
            20.verticalSpace,
            newArrivalCard('Lenovo Laptop', 'Reviews (4.9)', '\$ 15.59',
                'assets/NoPath - Copy (22)Toshiba.png'),
            24.verticalSpace,
            Text(
              'More Products',
              style: GoogleFonts.inter(
